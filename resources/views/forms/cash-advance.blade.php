    ...
    <div class="flex flex-1 overflow-hidden">
                            ...
                            <div class="grid grid-cols-4 gap-6">
                                <div>
                                    ...
                                    <input type="text" class="border rounded px-4 py-2 w-full focus:ring-2 focus:ring-[#2D73C5] focus:outline-none"
                                           x-model="row.ca_amount" />
                                </div>
                               <div>
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">DETAILS:</label>
                                    <textarea class="border rounded px-4 py-2 w-full focus:ring-2 focus:ring-[#2D73C5] focus:outline-none"
                                           x-model="row.rb_description" style="height: 100px; width: 800px; vertical-align: top; resize: none;"></textarea>
                                </div>
        ...
        <button type="button"
            ...
            ✕
                        ...
                        <div>
                            <label class="block text-gray-700 text-sm font-semibold mb-2">Noted By (Department Head):</label>
                            <input type="text" class="w-full border rounded px-4 py-2 focus:ring-2 focus:ring-[#2D73C5] focus:outline-none" />
                        </div>

                        <div>
                            <label class="block text-gray-700 text-sm font-semibold mb-2">Released By (Accounting):</label>
                            <input type="text" class="w-full border rounded px-4 py-2 focus:ring-2 focus:ring-[#2D73C5] focus:outline-none" />
                        </div>
