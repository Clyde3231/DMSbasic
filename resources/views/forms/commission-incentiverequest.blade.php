...
<head>
    ...
    <title>Commission - Incentive Request Form</title>
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <div class="flex-1 overflow-y-auto">
            <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between bg-white">
                <h1 class="text-xl font-semibold text-gray-800">Commission - Incentive Request Form</h1>
                       ...
                       <div>
                        ...
                        <template x-for="(row, index) in rows" :key="index">
                            <div class="grid grid-cols-4 gap-6">
                                <div>
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">PO / Proposal Number:</label>
                                    <input type="text" class="border rounded px-4 py-2 w-full focus:ring-2 focus:ring-[#2D73C5] focus:outline-none"
                                           x-model="row.com_proposalno" />
                                </div>
                                <div>
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">Project Name:</label>
                                    <input type="text" class="border rounded px-4 py-2 w-full focus:ring-2 focus:ring-[#2D73C5] focus:outline-none"
                                           x-model="row.com_projname" />
                                </div>
                             <div>
                                   <label class="block text-gray-700 text-sm font-semibold mb-2">Date Started:</label>
                                    <input type="text" class="border rounded px-4 py-2 w-full focus:ring-2 focus:ring-[#2D73C5] focus:outline-none"
                                           x-model="row.rb_amount" />
                                </div>          
                                <div>
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">Completion Date:</label>
                                    <input type="text" class="border rounded px-4 py-2 w-full focus:ring-2 focus:ring-[#2D73C5] focus:outline-none"
                                           x-model="row.rb_amount" />
                                </div>
            ...
            ✕
                        ...
                        <div class="flex justify-end">
                            <button type="button"
                                ...
                                @click="rows.push({ proposalno: '', projectname: '', datestarted: '', completiondate: '' })">
                                ➕ ADD MORE
