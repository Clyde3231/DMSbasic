    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <div class="flex-1 overflow-y-auto">
            <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between bg-white">
                <h1 class="text-xl font-semibold text-gray-800">Purchase Request Form</h1>
                       ...
                       <div>
                        ...
                        <template x-for="(row, index) in rows" :key="index">
                            <div class="grid grid-cols-4 gap-6">
                                <div>
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">Qty:</label>
                                ...
                                <div>
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">Unit Price:</label>
                                    <input type="text" class="border rounded px-4 py-2 w-full focus:ring-2 focus:ring-[#2D73C5] focus:outline-none"
                                           x-model="row.rb_receipt" />
                                </div>
                 
                                <div>
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">Total Price:</label>
                                    <input type="text" class="border rounded px-4 py-2 w-full focus:ring-2 focus:ring-[#2D73C5] focus:outline-none"
            ...
            ✕
                        ...
                        <div class="flex justify-end">
                            <button type="button"
                                ...
                                @click="rows.push({ qty: '', description: '', unitprice: '', totalprice: '' })">
                                ➕ ADD MORE
                        ...
                        <div class="mt-8">
                            <label class="block text-gray-700 text-sm font-semibold mb-2">PURPOSE / REASON:</label>
                            <textarea class="w-full border rounded px-4 py-2 focus:ring-2 focus:ring-[#2D73C5] focus:outline-none" rows="4"></textarea>
                        </div>




                            <label class="block text-gray-700 text-sm font-semibold mb-2">Requested By (Signature over printed name):</label>
                            <input type="text" class="w-full border rounded px-4 py-2 focus:ring-2 focus:ring-[#2D73C5] focus:outline-none" />
                        </div>
                        ...
                        <div>
                            <label class="block text-gray-700 text-sm font-semibold mb-2">Checked By(Department Head):</label>
                            <input type="text" class="w-full border rounded px-4 py-2 focus:ring-2 focus:ring-[#2D73C5] focus:outline-none" />
                        </div>

                        <div>
                            <label class="block text-gray-700 text-sm font-semibold mb-2">Approved By(President):</label>
                            <input type="text" class="w-full border rounded px-4 py-2 focus:ring-2 focus:ring-[#2D73C5] focus:outline-none" />
                        </div>
